...
_${gymName} — Powered by CrossFit App_ 🔥`;
  ...
  // Exercise GIF map - using exercisedb CDN (reliable public URLs)
  // Exercise image map — real photos from the free-exercise-db open dataset (no API key needed, hosted on GitHub)
  const EXERCISE_GIFS = {
    // CHEST
    ...
    "flat bench": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Bench_Press_-_Medium_Grip/0.jpg",
    ...
    "decline bench": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Barbell_Bench_Press/0.jpg",
    ...
    "cable cross": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Flat_Bench_Cable_Flyes/0.jpg",
    ...
    "push up": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Pushups/0.jpg",
    "pushup": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Pushups/0.jpg",
    // BACK
    "romanian deadlift": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Romanian_Deadlift/0.jpg",
    "rdl": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Romanian_Deadlift/0.jpg",
    ...
    "lat pull": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Wide-Grip_Lat_Pulldown/0.jpg",
    ...
    "bent-over row": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Bent_Over_Barbell_Row/0.jpg",
    "one-arm": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/One-Arm_Dumbbell_Row/0.jpg",
    "one arm": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/One-Arm_Dumbbell_Row/0.jpg",
    "single arm": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/One-Arm_Dumbbell_Row/0.jpg",
    "dumbbell row": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/One-Arm_Dumbbell_Row/0.jpg",
    "straight arm": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Straight-Arm_Pulldown/0.jpg",
    "face pull": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Face_Pull/0.jpg",
    // SHOULDERS
    "barbell shoulder": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Shoulder_Press/0.jpg",
    ...
    "dumbbell shoulder": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dumbbell_Shoulder_Press/0.jpg",
    ...
    "arnold": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Arnold_Dumbbell_Press/0.jpg",
    ...
    "rear delt": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cable_Rear_Delt_Fly/0.jpg",
    ...
    "skull": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/EZ-Bar_Skullcrusher/0.jpg",
    ...
    "overhead cable": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cable_Rope_Overhead_Triceps_Extension/0.jpg",
    "overhead dumbbell": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Overhead_Triceps/0.jpg",
    "overhead tricep": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Overhead_Triceps/0.jpg",
    "overhead extension": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Overhead_Triceps/0.jpg",
    ...
    "bodyweight squat": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Bodyweight_Squat/0.jpg",
    "squat": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Squat/0.jpg",
    ...
    "lunge": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Bodyweight_Walking_Lunge/0.jpg",
    ...
    // CALVES
    "standing calf": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Standing_Calf_Raises/0.jpg",
    "seated calf": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Seated_Calf_Raise/0.jpg",
    "donkey calf": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Donkey_Calf_Raises/0.jpg",
    "calf raise": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Standing_Calf_Raises/0.jpg",
    // CORE
    "ab wheel": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Ab_Rollout/0.jpg",
    "rollout": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Ab_Rollout/0.jpg",
    ...
    "hanging leg": "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hanging_Leg_Raise/0.jpg",
  ...
  const ExerciseGif = ({ name, color = "#00ff88", done = false }) => {
    ...
    const getGif = () => {
      // Find best matching key from EXERCISE_GIFS (keys are ordered specific -> generic)
      const keys = Object.keys(EXERCISE_GIFS);
      for (const k of keys) {
        if (n.includes(k)) return EXERCISE_GIFS[k];
      }
      return null; // no relevant photo — fall back to the icon instead of a misleading default
    };

    const gif = getGif();
    const [imgSrc, setImgSrc] = React.useState(gif);
    const [failed, setFailed] = React.useState(!gif);

    const fbEmoji = () => {
      if (n.includes("squat")||n.includes("lunge")||n.includes("leg")||n.includes("calf")||n.includes("hip")||n.includes("glute")) return "🦵";
      if (n.includes("run")||n.includes("sprint")||n.includes("jump")||n.includes("burpee")||n.includes("cardio")||n.includes("walk")) return "🏃";
      if (n.includes("stretch")||n.includes("yoga")||n.includes("foam")||n.includes("child")||n.includes("rest")||n.includes("breath")||n.includes("recovery")||n.includes("mobility")||n.includes("cool")||n.includes("relax")||n.includes("light")||n.includes("meditation")) return "🧘";
      if (n.includes("plank")||n.includes("crunch")||n.includes("ab")||n.includes("core")||n.includes("twist")||n.includes("rollout")||n.includes("raise")||n.includes("hanging")||n.includes("bicycle")||n.includes("mountain")||n.includes("woodchop")||n.includes("sit-up")) return "🔥";
      if (n.includes("bench")||n.includes("press")||n.includes("fly")||n.includes("pec")||n.includes("push")) return "🏋️";
      if (n.includes("curl")||n.includes("bicep")||n.includes("hammer")||n.includes("preacher")||n.includes("concentration")) return "💪";
      if (n.includes("row")||n.includes("pull")||n.includes("deadlift")||n.includes("shrug")||n.includes("face pull")) return "🏋️";
      if (n.includes("shoulder")||n.includes("lateral")||n.includes("front raise")||n.includes("rear delt")||n.includes("arnold")) return "🎯";
      if (n.includes("skull")||n.includes("pushdown")||n.includes("tricep")||n.includes("kickback")) return "💪";
      return "💪";
    };
    ...
    return (
      <div style={{
        ...
        background: failed ? `linear-gradient(135deg,${color}22,${color}08)` : "#111",
        border:`2px solid ${done ? color : color+"55"}`,
        boxShadow: done ? `0 0 20px ${color}66` : `0 4px 14px rgba(0,0,0,0.5)`,
        ...
        {!failed ? (
          ...
          <div style={{ fontSize:28, textAlign:"center" }}>{fbEmoji()}</div>
        )}
        {done && (
          <div style={{
            position:"absolute", inset:0, background:`${color}33`,
            display:"flex", alignItems:"center", justifyContent:"center",
          }}>
            <div style={{
              width:26, height:26, borderRadius:"50%", background:color,
              display:"flex", alignItems:"center", justifyContent:"center",
              fontSize:14, fontWeight:900, color:"#000", boxShadow:`0 0 12px ${color}`,
            }}>✓</div>
          </div>
        )}
      </div>
